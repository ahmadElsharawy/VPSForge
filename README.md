...
- **Modular Clean Architecture**: Modularized into 10 clean Bash modules under `lib/`.
...
## Reverse Proxy & Auto-SSL (Domains)

Route custom subdomains directly to your VPS containers with automated HTTPS certificates using Caddy via menu `#12`:
...
Create, restore, or export backups via menu `#13`:
